...
class _BookListScreenState extends State<BookListScreen> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Future<void> _loadFollowedComics() async {
    ...
    try {
      ...
      if (accountId == null) {
        setState(() {
          _isLoading = false;
          _error = 'Không tìm thấy account ID';
        });
        return;
      }
  ...
  Widget _buildSliverAppBar() {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        title: Text(
          languageProvider.translate('my_library'),
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                _buildStatItem(LanguageManager.translate('books'), totalBooks.toString(), Icons.book),
                _buildStatItem(LanguageManager.translate('pages_read'), totalPages.toString(), Icons.pages),
                _buildStatItem(LanguageManager.translate('avg_rating'), avgRating.toStringAsFixed(1), Icons.star),
              ],
            ),
            if (_isSearching) ...[
            ...
            Tab(
              child: Row(
                ...
                children: [
                  ...
                  Text('${LanguageManager.translate('in_progress')} (${_inProgressBooks.length})'),
                ],
              ),
            ),
            Tab(
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('${LanguageManager.translate('completed')} (${_completedBooks.length})'),
                ],
              ),
            ),
          ],
  ...
  Widget _buildInProgressTab() {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Lỗi: $_error', style: TextStyle(color: Colors.grey)),
              const SizedBox(height: 16),
              ElevatedButton(
    ...
    if (_followedComics.isEmpty) {
      return _buildEmptyState(
        ...
        subtitle: 'Hãy theo dõi truyện để xem chúng ở đây',
        buttonText: 'Khám phá',
        onPressed: () {},
      );
    }
  ...
  Widget _buildCompletedTab() {
    // Tab Completed luôn hiển thị empty state vì follow list không phân biệt completed
    return _buildEmptyState(
      icon: Icons.check_circle_outline,
      title: 'Chưa có truyện hoàn thành',
      subtitle: 'Hoàn thành truyện để xem chúng ở đây',
      buttonText: 'Đọc ngay',
      onPressed: () {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!book.isCompleted) ...[
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Finished: ${_formatLastRead(book.lastRead)}',
                          style: const TextStyle(
                            fontSize: 12,
                            color: AppTheme.textLight,
                          ),
      ...
      onTap: (index) {
        ...
        switch (index) {
          ...
          case 1:
            ...
            break;
          case 2:
            // Already on Book list screen - do nothing
            break;
          case 3:
            Navigator.push(
              context,
