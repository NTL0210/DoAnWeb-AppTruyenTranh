...
class _ExploreScreenState extends State<ExploreScreen> with TickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Gõ tên truyện hoặc thể loại để bắt đầu tìm kiếm',
                  textAlign: TextAlign.center,
              ...
              children: [
                ...
                Text(
                  _selectedGenres.isNotEmpty 
                      ? 'Thử chọn thể loại khác hoặc tìm kiếm với từ khóa khác'
  ...
  Widget _buildBottomNavigation() {
    ...
    return Container(
                      decoration: BoxDecoration(
        color: theme.bottomNavigationBarTheme.backgroundColor, // ✅ Dark mode
                                boxShadow: [
                                  BoxShadow(
            color: Colors.black.withOpacity(0.1),
            blurRadius: 8,
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            ...
            mainAxisAlignment: MainAxisAlignment.spaceAround,
              ...
              _buildNavItem(Icons.library_books, 'Book list', 2),
  ...
  // Mỗi mục trên thanh điều hướng: icon + nhãn + xử lý chuyển màn hình
